...
static INLINE void S9xFixCycles (void)
{
	if (CheckEmulation())
	{
		//printf("============================= Setting ICPU.S9xOpcodes to S9xOpcodesE1");
	...
	if (CheckMemory())
	{
		if (CheckIndex())
		{
			//printf("============================= Setting ICPU.S9xOpcodes to S9xOpcodesM1X1");
			ICPU.S9xOpcodes = S9xOpcodesM1X1;
			ICPU.S9xOpLengths = S9xOpLengthsM1X1;
		}
		else
		{
			//printf("============================= Setting ICPU.S9xOpcodes to S9xOpcodesM1X0");
	...
	if (CheckIndex())
	{
		//printf("============================= Setting ICPU.S9xOpcodes to S9xOpcodesM0X1");
		ICPU.S9xOpcodes = S9xOpcodesM0X1;
		ICPU.S9xOpLengths = S9xOpLengthsM0X1;
	}
	else
	{
		//printf("============================= Setting ICPU.S9xOpcodes to S9xOpcodesM0X0");
